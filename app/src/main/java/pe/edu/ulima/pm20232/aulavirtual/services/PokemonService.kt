...
class PokemonService {
    ...
    constructor() {
        ...
        pokemonList.add(Pokemon(id = 34, name = "NIDOKING", number = 34,weight = 62.0, height = 1.4, imageUrl = "https://pokefanaticos.com/pokedex/assets/images/pokemon_imagenes/34.png", generationId = 1,generationName = "PRIMERA"))
        pokemonList.add(Pokemon(id = 35, name = "CLEFAIRY", number = 35,weight = 7.5, height = 0.6, imageUrl = "https://pokefanaticos.com/pokedex/assets/images/pokemon_imagenes/35.png", generationId = 1,generationName = "PRIMERA"))
        pokemonList.add(Pokemon(id = 36, name = "CLEFABLE", number = 36,weight = 40.0, height = 1.3, imageUrl = "https://pokefanaticos.com/pokedex/assets/images/pokemon_imagenes/36.png", generationId = 1,generationName = "PRIMERA"))
        pokemonList.add(Pokemon(id = 37, name = "VULPIX", number = 37,weight = 9.9, height = 0.6, imageUrl = "https://pokefanaticos.com/pokedex/assets/images/pokemon_imagenes/37.png", generationId = 1,generationName = "PRIMERA"))
        pokemonList.add(Pokemon(id = 38, name = "NINETALES", number = 38,weight = 19.9, height = 1.1, imageUrl = "https://pokefanaticos.com/pokedex/assets/images/pokemon_imagenes/38.png", generationId = 1,generationName = "PRIMERA"))
        pokemonList.add(Pokemon(id = 39, name = "JIGGLYPUFF", number = 39,weight = 5.5, height = 0.5, imageUrl = "https://pokefanaticos.com/pokedex/assets/images/pokemon_imagenes/39.png", generationId = 1,generationName = "PRIMERA"))
        pokemonList.add(Pokemon(id = 40, name = "WIGGLYTUFF", number = 40,weight = 12.0, height = 1.0, imageUrl = "https://pokefanaticos.com/pokedex/assets/images/pokemon_imagenes/40.png", generationId = 1,generationName = "PRIMERA"))
    }
}