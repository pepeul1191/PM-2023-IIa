...
class ExerciseService {
    ...
    constructor(){
        ...
        exerciseList.add(Exercise(id = 34, name =  "PANTORRILLA EN MÁQUINA SMITH", imageUrl = "{baseUrl}ejercicios/pantoriilla01.png", videoUrl = "https://www.youtube.com/watch?v=F16IZhxfP3w", bodyPartId = 3, description = description))
        exerciseList.add(Exercise(id = 35, name =  "PANTORRILLA PARADO LIBRE", imageUrl = "{baseUrl}ejercicios/pantoriilla02.png", videoUrl = "https://www.youtube.com/watch?v=F16IZhxfP3w", bodyPartId = 3, description = description))
        exerciseList.add(Exercise(id = 36, name =  "PANTORRILLA PRENSA", imageUrl = "{baseUrl}ejercicios/pantoriilla03.png", videoUrl = "https://www.youtube.com/watch?v=F16IZhxfP3w", bodyPartId = 3, description = description))
        exerciseList.add(Exercise(id = 37, name =  "PANTORRILLA CON MANCUERNAS", imageUrl = "{baseUrl}ejercicios/pantoriilla04.png", videoUrl = "https://www.youtube.com/watch?v=F16IZhxfP3w", bodyPartId = 3, description = description))
        exerciseList.add(Exercise(id = 38, name =  "PANTORRILLA SENTADO", imageUrl = "{baseUrl}ejercicios/pantoriilla05.png", videoUrl = "https://www.youtube.com/watch?v=F16IZhxfP3w", bodyPartId = 3, description = description))
